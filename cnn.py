...
classifier.add(Dense(units = 2, activation = 'softmax')) # sigmoid for binary outcome softmax fpr more than 2 units


# Compiling the CNN
classifier.compile(optimizer = 'adam', loss = 'categorical_crossentropy', metrics = ['accuracy'])#categorical_crosentropy
...
classifier.save("model_face_cat.h5")   # save model for future purposes
